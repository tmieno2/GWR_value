...
Very good point. What makes this study differ from previous studies is that the model "value" is not measured by the accuracy of parameter estimates, but rather by the ultimate economic return. We have followed your suggestion above by expanding our review of previous studies to highlight what our research adds to the literature.  Please see in particular section 2.3 of the revised manuscript.
...
Thank you for the suggestion.   We have explicitly stated the following at the end of the Introduction section of the revised manuscript: *"While the environmental impacts of fertilizer management are of great social importance, for simplicity we confine our analysis to its private economic impacts."*
...
We apologize for the confusion. That figure was meant to compare the estimated and true GWR coefficients $\beta_1$ and $\beta_2$.  But since we have already compared the estimated and true EONR's in another figure, so the figure 4 was redundant. We have removed it from the revised manuscript. 
...
Thanks for pointing out the typo. Yes, it should be the square root of the sill variances since 1379 kg ha−1 was the mean of the standard deviations. We have corrected that typo in the revised manuscript at (page x, line xx in the revised manuscript).
...
Our apologies for the typos. We have corrected them and filled in the correct numbers. (See page x, line xx in the revised manuscript.)
...
Thank you for the suggestion. We agree that placing the commercial examples in a footnote is a better idea. Please see footnote 1 of the revised manuscript. 
...
We have followed the reviewer's suggestion and broken the discussion into two paragraphs In the revised manuscript.
...
The acronym DIFM has been placed after the full name in the revised manuscript.

<span style = "color: blue;">P. 10, line 212: The (j,k) index should be subscripted here.</span>  

Thanks for your careful reading. We have subscripted the indices in the revised manuscript where necessary.  
...
We have cited two additional of agronomic studies to support the statement in section 4.5.1 of the revised manuscript.
...
Done. We have put all acronyms in upper case throughout the revised manuscript.
...
Our apologies for the typo. It should have been Figure 5 and this problem is fixed in our new manuscript.
...
We have edited the sentence in the revised manuscript, adding detail to explain that other statistical methods commonly used for site-specific yield response estimation literature include regression on field characteristics variables as interaction terms, machine learning, etc. The common assessment approach is to use simulation-based evaluation, much much as we do in our study.
