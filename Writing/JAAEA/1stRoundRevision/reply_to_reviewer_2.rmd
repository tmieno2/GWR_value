...
Thanks for pointing out the typo. Yes, it should be the square root of the sill variances since 1370 kg ha−1 was the mean of the standard deviations. We have corrected that typo in the revised manuscript at the end of section 4.2.
...
Our apologies for the typos. We have corrected them and filled in the correct numbers. They can be found in the end of the 2nd paragraph of section 5.1 of the revised manuscript.

<span style = "color: blue;">P. 15: You first discuss figure 6 and then move to figure 5. Put all figures in order.</span>  

Thank you for identifying the incorrect order of figures. We apologize for the mistake, and we have corrected the order of the figures accordingly. The revised manuscript now reflects the correct sequence of Figures 5 and 6.
...
Thank you for the suggestion. We agree that placing the commercial examples in a footnote is a better approach. Please see footnote 1 of the revised manuscript. 
...
This typo has been removed. Thank you for bring it to our attention.
...
Thank you for pointing out those typos. They have all been corrected (see the end of the 2nd paragraph of section 5.1 of the revised manuscript).
...
We greatly appreciate the reviewer for identifying this typo. It was corrected in the revised manuscript.
