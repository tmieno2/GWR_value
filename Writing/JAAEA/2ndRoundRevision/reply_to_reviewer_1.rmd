...
This comment clearly shows that this reviewer did not pay attention to our replies to his comments (the first round review, comment 1). In our reply to his comments, we clearly stated that the site-specific parameters are indeed spatially correlated. We also ensured that the coefficients on the linear and quadratic N-rates were constrained to be positive and negative. This is not a hard task. We share all the codes written in R on a publicly accessible repository. Anybody can check how this was done in our paper.
...
Clarifying sentences were added to page ??, line ??.
...
We agree that we can provide more information on how the data is generated. The error term follows the normal distribution with spatial correlation (a sentence on this added on page ??, line ??). 
